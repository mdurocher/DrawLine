...
public class ScaleFilter extends AbstractBufferedImageOp {
  ...
  public BufferedImage filter(BufferedImage src, BufferedImage dst) {
    if (dst == null) {
      ...
      dst = new BufferedImage(dstCM, dstCM.createCompatibleWritableRaster(width, height), dstCM.isAlphaPremultiplied(),
          null);
    }

    final Image scaleImage = src.getScaledInstance(width, height, Image.SCALE_AREA_AVERAGING);
