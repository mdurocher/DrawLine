...
package shapeFile.shapeFile;

import java.io.File;
import java.util.ArrayList;

import shapeFile.files.dbf.DBF_Field;
import shapeFile.files.dbf.DBF_File;
import shapeFile.files.shp.SHP_File;
import shapeFile.files.shp.shapeTypes.ShpShape;
import shapeFile.files.shx.SHX_File;
...
public class ShapeFile {
  ...
  // library info
  public final static String _LIBRARY_NAME = "shapeFileReader";
  ...
  // mandatory files
  private SHX_File shx_file; // index-File: contains offsets and content lengths
                             // of each record in the main shp-file.
  ...
  /**
   * same as: {@link shapeFile.files.shp.SHP_Header#getBoundingBox()}
   * 
  ...
  /**
   * same as: {@link shapeFile.files.dbf.DBF_File#getContent()}
   * 
  ...
  public static void main(String[] a) {
    ...
    String basename = "natural";
    ShapeFile s = null;
    try {
      s = new ShapeFile(path, basename);
      s.read();
    } catch(Exception e) {
      e.printStackTrace();
    }
