...
public class WarpFilter extends WholeImageFilter {
  ...
  public void morph(int[] srcPixels, int[] destPixels, int[] outPixels, WarpGrid srcGrid, WarpGrid destGrid, int width,
      int height, float t) {
  ...
  /**
   * For morphing, sets the image we're morphing to. If not, set then we're just
   * warping.
   */
