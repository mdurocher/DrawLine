...
public class PerspectiveFilter extends TransformFilter {
  ...
  public Rectangle2D getBounds2D(BufferedImage src) {
    ...
    final float w = src.getWidth(), h = src.getHeight();
  ...
  /**
   * Get the origin of the output image. Use this for working out where to draw
   * your new image.
   *
   * @return the X origin.
   */
   ...
   * unitSquareToQuad, but the coordinates are in image pixels, not relative to
   * the unit square. This method is provided as a convenience.
   *
   * @param x0
   *          the new position of the top left corner
   * @param y0
